...
The key point of disagreement within the literature is whether short-term memory is computed by the same processes that encode and retrieve long term memory (the 'unitary view'), or by dedicated, temporally limited processes (the 'dual-store' or 'dual-process' view) \cite{Raaijmakers1980,Davelaar2005,Sederberg2008}.
