...
In this way \cite{Cowan2008} leaves open the possibility for both decay of active maintenance and interference between stored representations as mechanisms of forgetting. This is a further site of contest between buffer and attentional theories \cite{Jonides2008}, with attentional theories traditionally operating on memory representations encoded such that memories which are most different, either in content, context, or time-of-perception, suffer least mutual interference from other encoded memories, and hence greater recall \cite{Nairne1997,Brown2002,Brown2008,Howard2002}. 
